...
export const ROUTER_DATABASE: Record<string, RouterModelInfo> = {
  ...
  'RT-AX58U': {
    ...
    wifiBands: ['2.4GHz', '5GHz'],
    maxSpeed: 3000,
    capabilities: ['aimesh', 'smart_connect', 'band_steering', 'mu_mimo', 'ofdma', 'wpa3'],
    sshInterface: { wl0: 'eth4', wl1: 'eth5' },
    nvramPrefix: { wifi2g: 'wl0', wifi5g: 'wl1' },
    aimeshRole: 'both',
  },
  'RT-AX55': {
    ...
    wifiBands: ['2.4GHz', '5GHz'],
    maxSpeed: 1800,
    capabilities: ['aimesh', 'mu_mimo', 'ofdma', 'wpa3'],
    sshInterface: { wl0: 'eth4', wl1: 'eth5' },
    nvramPrefix: { wifi2g: 'wl0', wifi5g: 'wl1' },
    aimeshRole: 'node',
  },
  ...
  'RT-AX92U': {
    ...
    maxSpeed: 6100,
    capabilities: ['aimesh', 'smart_connect', 'band_steering', 'mu_mimo', 'ofdma', 'wpa3', '160mhz'],
    sshInterface: { wl0: 'eth5', wl1: 'eth6', wl2: 'eth7' },
    nvramPrefix: { wifi2g: 'wl0', wifi5g: 'wl1', wifi5g2: 'wl2' },
    aimeshRole: 'both',
  },
  'ZenWiFi AX Mini (XD4)': {
    model: 'ZenWiFi AX Mini (XD4)',
    generation: 'wifi6',
    wifiBands: ['2.4GHz', '5GHz'],
    maxSpeed: 1800,
    capabilities: ['aimesh', 'mu_mimo', 'ofdma', 'wpa3'],
  ...
  'ZenWiFi Pro XT12': {
    ...
    wifiBands: ['2.4GHz', '5GHz', '5GHz-2'],
    maxSpeed: 11000,
    capabilities: ['aimesh_2', 'smart_connect', 'band_steering', 'mu_mimo', 'ofdma', 'wpa3', '160mhz', '10g_wan', '2.5g_wan'],
    sshInterface: { wl0: 'eth6', wl1: 'eth7', wl2: 'eth8' },
    nvramPrefix: { wifi2g: 'wl0', wifi5g: 'wl1', wifi5g2: 'wl2' },
    aimeshRole: 'both',
  },
  ...
  'RT-BE96U': {
    ...
    wifiBands: ['2.4GHz', '5GHz', '6GHz'],
    maxSpeed: 9600,
    capabilities: ['aimesh_2', 'smart_connect', 'band_steering', 'mu_mimo', 'ofdma', 'wpa3', '320mhz', 'mlo', '2.5g_wan'],
    sshInterface: { wl0: 'eth6', wl1: 'eth7', wl2: 'eth8' },
    nvramPrefix: { wifi2g: 'wl0', wifi5g: 'wl1', wifi6g: 'wl2' },
    aimeshRole: 'both',
  },
